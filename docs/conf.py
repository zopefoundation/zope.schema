#
# zope.schema documentation build configuration file, created by
...
latex_documents = [
    ('index', 'zopeschema.tex', 'zope.schema Documentation',
...
man_pages = [('index', 'zopeschema', 'zope.schema Documentation',
...
texinfo_documents = [
    ('index', 'zopeschema', 'zope.schema Documentation',
     'Zope Foundation Contributors', 'zopeschema',
